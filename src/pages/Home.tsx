            ...
            <div className="flex flex-row h-[500px] items-center justify-center rounded-[30px] bg-portal-green my-20 mx-[200px] shadow-gray shadow-lg">
                <div className="text-white flex flex-col w-[50%] h-full font-bold text-[30px] items-center justify-center mx-4">
                    ...
                    <div className='flex flex-row m-10 space-x-5 text-lg'>
                        <button className='bg-yellow rounded-lg px-4 py-2 text-black transition ease-in-out hover:scale-110 delay-80 hover:-translate-y-1'>Ver Produtos</button>
                        <button className=' text-yellow rounded-lg px-4 py-2 transition ease-in-out delay-80 hover:scale-110 hover:-translate-y-1'>Saiba mais</button>
                    </div>
                </div>
